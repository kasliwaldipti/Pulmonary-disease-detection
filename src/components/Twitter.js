...
class Twitter extends Component {
  ...
  render() {
    ...
    const handleOnSelect = (item) => {
      ...
      console.log(item);
      var city = item.name;
      var firstpart = "https://twitter.com/search?q=verified+";
      var secondpart =
        "+%28bed+OR+beds+OR+icu+OR+oxygen+OR+ventilator+OR+ventilators%29+-%22not+verified%22+-%22unverified%22+-%22needed%22+-%22need%22+-%22needs%22+-%22required%22+-%22require%22+-%22requires%22+-%22requirement%22+-%22requirements%22&f=live";
      var link1 = firstpart + city + secondpart;
        ...
        <Form style={{ width: "75%" }}>
          ...
          >
            <Modal.Header
              ...
              style={{
                background:
                  "linear-gradient(to right, #205a58, #2b7a78, #3aafa9)",
                color: "#feffff",
              }}
            >
              Alert!
            ...
            <Modal.Body>
              This link will redirect you to Twitter. Are you sure you want to
              redirect?
              <br />
              <br />
              <center>
